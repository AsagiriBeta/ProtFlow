"""
Analysis Notebook Initialization Template

This cell should be placed at the beginning of analysis notebooks.
It will:
1. Add protflow to Python path
2. Setup the environment and paths
3. Check and install analysis dependencies
...
# 4. Common imports for analysis notebooks
import pandas as pd
import numpy as np
...
# Optional: py3Dmol for structure visualization
try:
    import py3Dmol
except ImportError:
    pass
